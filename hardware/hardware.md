...
The files are provided in `.step` format.
...
## Electrical
Files are in `./electrical`. This directory contains KiCad documents for the level-shifting PCB that attaches to the Raspberry Pi.
